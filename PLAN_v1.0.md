...
> Включает: детерминированный AST-анализ проектов (Tree-sitter без расхода токенов LLM), маркировку связей (EXTRACTED/INFERRED), выявление архитектурных хабов (God Nodes), пространства проектов (`project_id`) и поддержку 7+ ИИ-агентов (Hermes, Claude Code, Cursor, ZCode, Gemini CLI, Qwen Code, OpenCode).
